...
$destino="fotosDiagnostico/".$Foto;
copy($ruta,$destino);

//conuslta SQL
$sql = "INSERT INTO diagnostico (cod_admi, cod_perro, sintoma, diagnosticoTS, medicamentos, costoConsulta, FotoRX) ";
$sql .= "VALUES ('$v0', '$v1', '$v2', '$v3', '$v4', '$v5', '$destino' )";
